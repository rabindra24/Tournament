...
const TournamentSetting = (props) => {
  ...
  const submitHandler = (e) => {
    ...
    axios
      .post(`http://localhost:3000/tournament/update`, {
        ...tournament,
        OID,
        id,
      })
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/tournament/`, { params: { TID: id } })
      .then((res) => {
        console.log(res.data.result[0]);
        const { T_end, T_name, T_start, Teams, GID, G_name } =
          res.data.result[0];
          const newDate = new Date(T_start).toISOString().split('T')[0]
    console.log(newDate);
        ...
        setTournament({
          ...
          game: GID,
          team: Teams,
          startDate: new Date(T_start).toISOString().split('T')[0],
          endDate: new Date(T_end).toISOString().split('T')[0],
          mode: "",
        });
      });
